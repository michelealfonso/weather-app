...
export default function Time() {
  ...
  return (
    <div className="w-full h-screen p-5 md:p-20 flex justify-center items-center">
      <div className="h-[500px] w-[500px] flex flex-col bg-white rounded-xl text-center shadow-lg shadow-black">
        <div className="my-10">
          <h1 className="mb-10 font-bold text-4xl text-center">Weather App</h1>
          <input
            type="text"
            placeholder="Search City..."
            className="text-white rounded-3xl pl-5 bg-[#4d4d4d] w-[200px] outline-none p-2 text-lg duration-500 focus:w-[50%]"
